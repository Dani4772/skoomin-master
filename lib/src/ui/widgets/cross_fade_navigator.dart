...
class CrossFadeNavigator extends StatefulWidget {
  ...
  @override
  createState() => _CrossFadeNavigatorState();
}

class _CrossFadeNavigatorState extends State<CrossFadeNavigator>
    with TickerProviderStateMixin {
  late Animation<Color?> nav1;
  late Animation<Color?> nav2;
